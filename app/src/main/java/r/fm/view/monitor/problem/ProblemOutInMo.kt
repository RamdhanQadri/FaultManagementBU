...
class ProblemOutInMo: Fragment(), AnkoComponent<Context>, HomeViewMonitor {
                ...
                -> {
                    ...
                    share.setOnClickListener {
                        try {
                            ...
                            var copi: String? = "Problem > 1 Hari : ${item.size} ATM. Waktu Insert : ${item[0].waktuinsertu}  \n\n"
                            for (problem in item) {
