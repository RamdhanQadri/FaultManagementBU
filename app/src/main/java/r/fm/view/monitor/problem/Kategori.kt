...
class Kategori : Fragment(), AnkoComponent<Context>, HomeViewMonitor {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val spinnerItem = resources.getStringArray(R.array.kategoriProblem)
        ...
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: View, position: Int, id: Long) {
                problem = spinner.selectedItem.toString()
                presenter.getProblemOutInKategoriSSI(problem)
            }
    ...
    override fun showProb(data: List<ItemDamper>) {
        ...
        share.setOnClickListener {
            try {
                ...
                var copi: String? =
                    "Problem ${problem} : ${item.size} ATM. Waktu Insert : ${item[0].waktuinsertu}  \n\n"
                for (problem in item) {
